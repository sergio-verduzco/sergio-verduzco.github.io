...
- In the case of $f_{\theta}$ I used a single 60-unit layer that could optionally use GRU units.
...
A possible solution was therefore to reduce the dimension of $\mathbf{z}$, and use less
